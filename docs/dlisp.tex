...
\lstset{language=Caml,label=org6b2794e,caption={History node},captionpos=b,numbers=none}
\begin{lstlisting}
type history_node =
  | Main of
      (node ref * node) *
...
\lstset{language=Caml,label=orgf002150,caption={Update},captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=Lisp,label=org416c9e1,caption={Append},captionpos=b,numbers=none}
\begin{lstlisting}
;; ++ は append
...
\lstset{language=Lisp,label=org1d13a92,caption={Circle},captionpos=b,numbers=none}
\begin{lstlisting}
(let ((x '(1 2 3)))
  (let ((y (++ x x)))
    (begin
