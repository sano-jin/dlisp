...
\lstset{language=Caml,label=org5979af7,caption={History node},captionpos=b,numbers=none}
\begin{lstlisting}
type history_node =
  | Main of
      (node ref * node) *
...
\lstset{language=Caml,label=org79212f5,caption={Update},captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=Lisp,label=orgb53fa86,caption={Append},captionpos=b,numbers=none}
\begin{lstlisting}
;; ++ は append
...
\lstset{language=Lisp,label=org43644c0,caption={Circle},captionpos=b,numbers=none}
\begin{lstlisting}
(let ((x '(1 2 3)))
  (let ((y (++ x x)))
    (begin
