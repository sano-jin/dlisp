...
\lstset{language=Caml,label=orgf06b77a,caption={History node},captionpos=b,numbers=none}
\begin{lstlisting}
type history_node =
  | Main of
      (node ref * node) *
...
\lstset{language=Caml,label=orga3043cb,caption={Update},captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=Lisp,label=org9226724,caption={Append},captionpos=b,numbers=none}
\begin{lstlisting}
;; ++ は append
...
\lstset{language=Lisp,label=orgd5f829e,caption={Circle},captionpos=b,numbers=none}
\begin{lstlisting}
(let ((x '(1 2 3)))
  (let ((y (++ x x)))
    (begin
