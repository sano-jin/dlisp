...
\lstset{language=Caml,label=org1c8dea5,caption={History node},captionpos=b,numbers=none}
\begin{lstlisting}
type history_node =
  | Main of
      (node ref * node) *
...
\lstset{language=Caml,label=orgc65d160,caption={Update},captionpos=b,numbers=none}
\begin{lstlisting}
...
\lstset{language=Lisp,label=org8953c16,caption={Append},captionpos=b,numbers=none}
\begin{lstlisting}
;; ++ は append
...
\lstset{language=Lisp,label=orgf5053a7,caption={Circle},captionpos=b,numbers=none}
\begin{lstlisting}
(let ((x '(1 2 3)))
  (let ((y (++ x x)))
    (begin
